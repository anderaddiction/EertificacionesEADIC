                        ...
                        <div class="consequence">
                            <div class="search-ticket" style="display:none">
                                <form class="form-horizontal" method="POST" action="{{ route('consulta.find') }}" id="seach-form" name="seach-form"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="ticket_diplomaynotas" name="ticket_diplomaynotas"
                            ...
                            <div class="show-iframe" style="display:none">
                                <div class="row text-center">
                                    <div class="col-sm-3"></div>
                                    <div class="col-sm-6">
                                        <button type="button" class="btn btn-block btn-success">{{ __('Create a ticket') }}</button>
                                    </div>
                                    <div class="col-sm-3"></div>
                                </div>
                            </div>
